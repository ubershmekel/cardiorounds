...
enum Zone {
  z1('Z1', 'Rest', 0.60, Color(0xFF9E9E9E)),
  z2('Z2', 'Light', 0.70, Color(0xFF2196F3)),
  z3('Z3', 'Moderate', 0.80, Color(0xFF4CAF50)),
  z4('Z4', 'Hard', 0.90, Color(0xFFFF9800)),
  z5('Z5', 'Max', double.infinity, Color(0xFFE91E63));

  const Zone(this.shortLabel, this.name, this.upperFraction, this.color);
